;
; NES controller and Zapper trigger reading code
...
;
; 2011-09: map Zapper trigger to A Button
...
; turn ZAPPER_TO_A on to enable pressing A with the light gun
.ifndef ZAPPER_TO_A_BUTTON
ZAPPER_TO_A_BUTTON = 0
.endif
...
.if ::ZAPPER_TO_A_BUTTON
  lda $4016,x
  and #$10
  beq @notZapperTrigger
  lda #KEY_A
  ora cur_keys,x
  sta cur_keys,x
@notZapperTrigger:
